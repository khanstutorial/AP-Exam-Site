...
def makeFile(nbrhood):
    ...
    titleString = "id=\"Neighborhood Title\">AP Exams - Khan's Tutorial</title>"
    bannerString = "id=\"Neighborhood 1\">Advanced Placement Tutoring</h1>"
    featureString = "Why do families choose Khan's"
    newTString = titleString.replace("AP Exams - Khan's Tutorial</title>",nbrhood.replace('-',' ')+" AP Exams - Khan's Tutorial</title>")
    newBString = bannerString.replace("Advanced Placement Tutoring</h1>",nbrhood.replace('-',' ')+" Advanced Placement Tutoring</h1>")
